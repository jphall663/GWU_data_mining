...
Variable importance measures are usually global in scope, however the LOCO approach offers local variable importance measure for each row in a training set or in new data.
